...
public class Pending_frg extends Fragment {

    RecyclerView recyclerView;
    Pending_Adapter cOnfirm_adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_pending_frg, container, false);
        recyclerView=view.findViewById(R.id.recycler_viewPending);
        ...
        FirebaseDatabase.getInstance().getReference().child("Booking").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot snapshot1:snapshot.getChildren()){
                    if (snapshot1.child("booking_status").getValue(String.class).equals("0")){
                ...
                cOnfirm_adapter=new Pending_Adapter(getContext(),list);
