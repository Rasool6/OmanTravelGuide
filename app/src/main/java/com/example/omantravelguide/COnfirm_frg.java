...
public class COnfirm_frg extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_c_onfirm_frg, container, false);
             recyclerView=view.findViewById(R.id.recycler_viewConfirm);
    ...
    private void fetchConfirmOrder() {
        FirebaseDatabase.getInstance().getReference().child("Booking").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                cOnfirm_adapter=new COnfirm_Adapter(getContext(),list);
