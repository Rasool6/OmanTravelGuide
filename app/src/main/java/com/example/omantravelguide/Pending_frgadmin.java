...
public class Pending_frgadmin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pending_frgadmin, container, false);
        recyclerView=view.findViewById(R.id.recycler_viewConfirmAdmin);
